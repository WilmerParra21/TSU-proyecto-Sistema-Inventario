...
<form id="formulary" action="#" method="post" class="" accept-charset="utf-8">
...
<div class="mt-5 separador">
<label for="clave">Contraseña:</label>
<input type="password"placeholder="Ingrese su Clave" id="clave" name="clave" onpaste="return false">
</div>

<div class="d-flex">
<p class="text-light font-italic m-2">¿No estás registrado?</p><a href="registro.php" class="nav-link text-light">Registrate aqui</a>
</div>
