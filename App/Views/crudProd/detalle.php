...
$cox = new Conex();
$sentencia = $cox->Conection()->prepare('SELECT * FROM producto, categoria WHERE producto.id_Producto = 8 and producto.idCategoria = categoria.idCategoria');
...
<a href="listar.php" class="btn btn-outline-primary ml-5 mb-5">Volver atrás</a>
