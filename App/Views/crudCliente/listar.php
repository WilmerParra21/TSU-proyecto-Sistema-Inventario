<?php
	...
	$sentencia = $cox->Conection()->query('SELECT * FROM cliente;');
...
<p class="card-text font-italic mr-4 border-bottom border-dark pb-2">Generar Reporte PDF de todo el registro de Clientes</p>
	...
	<a href="../../Models/ReportPdf/clientePDF.php" class="btn btn-danger badge-pill"><i class="fas fa-download"></i> Obtener en PDF</a>
